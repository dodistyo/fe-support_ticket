            ...
            <div class="vx-col w-full lg:w-1/3 mb-base">
                <vx-card title="Customers">
                    ...
                    <div slot="no-body">
                        ...
                        <!-- CHART DATA -->
                        <ul class="mb-1">
                            <li v-for="customerData in analyticsData.customersPie.analyticsData" :key="customerData.customerType" class="flex justify-between py-3 px-6 border border-grey-light border-solid border-r-0 border-l-0 border-b-0">
                                <span class="flex items-center">
        ...
        <div class="vx-row">
            ...
            <div class="vx-col w-full md:w-1/2 mb-base">
                <vx-card class="overflow-hidden">
                    <template slot="no-body">
                        <div class="flex justify-between items-center p-6 border border-solid border-grey-light border-r-0 border-l-0 border-t-0">
                            <div>
            ...
            <div class="vx-col w-full md:w-1/3 lg:w-1/4 xl:w-1/4">
                <vx-card>
                    <template slot="no-body">
                        ...
                        <div class="p-8 border border-grey-light border-solid border-r-0 border-l-0 border-b-0">
                            <div class="mb-4">
