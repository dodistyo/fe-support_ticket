...
<template>
    <vx-card title="State" code-toggler>
        ...
        <p>There are times when we need to add a state to our tr in the table so we have the property <strong>state</strong> inside the component <code>vs-tr</code><br></p>
